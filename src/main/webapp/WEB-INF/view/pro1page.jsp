...
<div class="row">
 ...
 <!-- START THE FEATURETTES -->
	<div class="container">
     ...
     <div class="row">
    <div class="col-sm-3">
     <center> <a href="aboutpage.html">  <img src="E:\wallpapers\images of landing page\flo20.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color: purple; font-weight:bold; "><i>Transparent candle </i><span class="text-muted" > </span></h3>
	 ...
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>
       ...
       <div class="col-sm-3"> 
      <center> <a href="contactpage.html">  <img src="E:\wallpapers\images of landing page\flo37.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color:purple; font-weight:bold; "><i>Multicolor lighting</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $20</p>
 <p><a class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>   
    </div>
	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\pic11.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>Flower candle</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $30</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button" >View details &raquo;</a></p></center>   
    </div>

	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\flo94.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>Piniatta lighting ball</i><span class="text-muted"></span></h3>
  ...
  <!-- START THE FEATURETTES -->
	<div class="container">
     ...
     <div class="row">
    <div class="col-sm-3">
     <center> <a href="aboutpage.html">  <img src="E:\wallpapers\images of landing page\pic12.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color: purple; font-weight:bold; "><i>skull candle </i><span class="text-muted" > </span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $50</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>
    </div>
    
       <div class="col-sm-3"> 
      <center> <a href="contactpage.html">  <img src="E:\wallpapers\images of landing page\flo95.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color:purple; font-weight:bold; "><i>heart shape lighting</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $60</p>
 <p><a class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>   
    </div>
	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\pic9.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>Snake candle</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $70</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button" >View details &raquo;</a></p></center>   
    </div>

	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\flo96.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>flower solar lighting</i><span class="text-muted"></span></h3>
