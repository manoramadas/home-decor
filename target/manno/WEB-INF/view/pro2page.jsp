...
<div class="row">
 ...
 <!-- START THE FEATURETTES -->
	<div class="container">
     ...
     <div class="row">
    <div class="col-sm-3">
     <center> <a href="aboutpage.html">  <img src="E:\wallpapers\images of landing page\flo85.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color: purple; font-weight:bold; "><i>Balck and white printed bedsheet </i><span class="text-muted" > </span></h3>
	 ...
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>
       ...
       <div class="col-sm-3"> 
      <center> <a href="contactpage.html">  <img src="E:\wallpapers\images of landing page\pic3.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color:purple; font-weight:bold; "><i>subtle embroidered cushion</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $20</p>
 <p><a class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>   
    </div>
	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\flo25.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>3D rose flower bedsheet</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $30</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button" >View details &raquo;</a></p></center>   
    </div>

	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\flo32.png" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>Pink and white cushion</i><span class="text-muted"></span></h3>
  ...
  <!-- START THE FEATURETTES -->
	<div class="container">
     ...
     <div class="row">
    <div class="col-sm-3">
     <center> <a href="aboutpage.html">  <img src="E:\wallpapers\images of landing page\pic46.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color: purple; font-weight:bold; "><i>one side printed bedsheet </i><span class="text-muted" > </span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $50</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>
    </div>
    
       <div class="col-sm-3"> 
      <center> <a href="contactpage.html">  <img src="E:\wallpapers\images of landing page\flo31.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color:purple; font-weight:bold; "><i>beautiful printed cushion</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $60</p>
 <p><a class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>   
    </div>
	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\flo100.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>3D black alien bedsheet</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $70</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button" >View details &raquo;</a></p></center>   
    </div>

	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\flo101.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>shimmer elongated cushion</i><span class="text-muted"></span></h3>
