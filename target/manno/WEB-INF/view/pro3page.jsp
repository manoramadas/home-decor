...
<div class="row">
 ...
 <!-- START THE FEATURETTES -->
	<div class="container">
     ...
     <div class="row">
    <div class="col-sm-3">
     <center> <a href="aboutpage.html">  <img src="E:\wallpapers\images of landing page\flo23.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color: purple; font-weight:bold; "><i>Peacock feather dream catcher </i><span class="text-muted" > </span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $10</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>
    </div>
    
       <div class="col-sm-3"> 
      <center> <a href="contactpage.html">  <img src="E:\wallpapers\images of landing page\flo28.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color:purple; font-weight:bold; "><i>sea shell decorated ring</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $20</p>
 <p><a class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>   
    </div>
	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\flo38.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>multicolor feather dream catcher</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $30</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button" >View details &raquo;</a></p></center>   
    </div>

	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\flo92.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>copper flower wall hanging</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $40</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button" >View details &raquo;</a></p></center>   
    </div>
	</div>
  ...
  <!-- START THE FEATURETTES -->
	<div class="container">
     ...
     <div class="row">
    <div class="col-sm-3">
     <center> <a href="aboutpage.html">  <img src="E:\wallpapers\images of landing page\flo90.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color: purple; font-weight:bold; "><i>weaved dreamcatcher wall hanging </i><span class="text-muted" > </span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $50</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>
    </div>
    
       <div class="col-sm-3"> 
      <center> <a href="contactpage.html">  <img src="E:\wallpapers\images of landing page\pic48.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading" style="color:purple; font-weight:bold; "><i>metal windchimes</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $60</p>
 <p><a class="btn btn-default" href="aboutuspage.html" role="button">View details &raquo;</a></p></center>   
    </div>
	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\pic47.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>copper crystal wall hanging</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $70</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button" >View details &raquo;</a></p></center>   
    </div>

	<div class="col-sm-3"> 
       <center><a href="flowpage.html">  <img src="E:\wallpapers\images of landing page\flo29.jpg" alt="Flower" class="img thumbnail" class="img-responsive" width="200" height="200"></a>
      <h3 class="featurette-heading"style="color:purple; font-weight:bold; "><i>paper made butterfly</i><span class="text-muted"></span></h3>
          <p class="lead" style="color:balck; font-weight:normal">Price: $80</p>
	 <p><a  class="btn btn-default" href="aboutuspage.html" role="button" >View details &raquo;</a></p></center>   
    </div>
	</div>
...
<a href-"https://www.youtube.com/user/SCFLibrary" target="_blank" > <i class="fa fa-youtube"></i></a></br>
