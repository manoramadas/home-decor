 ...
 <nav class="navbar navbar-inverse" style=" font-weight:bold ">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
	 ...
	 <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color:lightblue">Products <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="#">Wall Hangings</a></li>
            <li><a href="#">Bedsheets and Cushions</a></li>
            <li><a href="#">Candles and Lightings</a></li>
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="loginpage.html" style="color:lightblue"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
    </ul>
  </div>
</nav>
...
width:100%;
        ...
        <div class="col-md-7">
          <center><a href="pro1page.html"><h2 class="featurette-heading" style="color:purple; font-weight:bold"><i>The lighting and candles </i><span class="text-muted" >..... </span></h2></a>
          <p class="lead" style="color:balck; font-weight:bold">Say bye to darkness and hello to pretty and lighted homes....</p>
	 <p><a class="btn btn-default" href="pro1page.html" role="button">View details &raquo;</a></p></center>
        </div>
        <div class="col-md-5">
          <a href="pro1page.html"><img class="featurette-image img-responsive center-block" img src="E:\wallpapers\images of landing page\pic18.jpg"  alt="Generic placeholder image" width="250" height="250"></a>
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-7 col-md-push-5">
          <center><a href="pro2page.html"><h2 class="featurette-heading" style="color:purple; font-weight:bold"><i>Bedsheets and cushions</i><span class="text-muted">....</span></h2></a>
          <p class="lead" style="color:balck; font-weight:bold">Feel homely with best brand and quality of cushions and bedsheets....</p>
 <p><a class="btn btn-default" href="pro2page.html" role="button">View details &raquo;</a></p></center>
        </div>
        <div class="col-md-5 col-md-pull-7">
          <a href="pro2page.html"><img class="featurette-image img-responsive center-block" class="img-circle" src="E:\wallpapers\images of landing page\flo87.jpg"  alt="Generic placeholder image" width="250" height="250"></a>
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <center><a href="pro3page.html"><h2 class="featurette-heading"style="color:purple; font-weight:bold"><i>Wall hangings</i><span class="text-muted">....</span></h2></a>
          <p class="lead" style="color:balck; font-weight:bold">And lastly, this one, give your home a new face with our beautiful wall hangings and decors....</p>
	 <p><a class="btn btn-default" href="pro3page.html" role="button">View details &raquo;</a></p></center>
        </div>
        <div class="col-md-5">
          <a href="pro3page.html"><img class="featurette-image img-responsive center-block" img src="E:\wallpapers\images of landing page\flo91.jpg"  alt="Generic placeholder image"  width="250" height="250"></a>
        </div>
      </div>
	</div>
